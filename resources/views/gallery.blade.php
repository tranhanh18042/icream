...
<head>
    ...
    <link href="{{ asset('css/icream/style.css') }}" rel="stylesheet">
</head>
...
<body>
    ...
    <div class="container-fluid py-5 px-0">
        <div class="container py-5">
            <div class="row justify-content-center">
                <div class="col-lg-5">
                    <h1 class="section-title position-relative text-center mb-5">Delicious Ice Cream Made From Our Very
                        Own Organic Milk</h1>
                </div>
            </div>
            <div class="row">
                ...
                @foreach ($listImages as $image)
                    <div class="col-lg-4 col-md-6 p-0 portfolio-item first">
                        <div class="position-relative overflow-hidden">
                            ...
                            <a class="portfolio-btn" href="{{$image->url}}" data-lightbox="portfolio">
    ...
    <script src="css/easing/easing.min.js"></script>
    <script src="css/waypoints/waypoints.min.js"></script>
    <script src="css/owlcarousel/owl.carousel.min.js"></script>
    <script src="css/isotope/isotope.pkgd.min.js"></script>
